...
const burger = {
	...
	indirim:  (function (str){ return  str === "öğrenci" || str === "öğretmen" ? this.fiyat * 0.75 : this.fiyat * 0.90})
}
...
degerlendirmeler.filter( (obj) => obj.isim === "Reyna")[0].geribildirim = "bu mekan bir harika dostum, yine de garsonun gülümsememesinden puan kırdım";
...
/*  Görev 6: 
	Dizideki değerlendirmelerin anahtarına(key,index) bağlı olarak değerlendirme döndüren bir fonksiyon yazın
