...
console.log(yasim);
console.log(yasim + " is " + typeof yasim);
...
function randIntGenerator(number){
  /*
    This function generates a random in the range [0,number)
  */
  return Math.floor(Math.floor() * number);
}

function assignType(number){
  if (number === 0){
    return "Taş";
  }
  else if(number === 1){
...
var oyuncu = assignType(randIntGenerator(3));
var bilgisayar = assignType(randIntGenerator(3));
